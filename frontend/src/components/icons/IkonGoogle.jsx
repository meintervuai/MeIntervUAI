/** Ikon Google — logo resmi 4 warna (khusus tombol masuk). */
export default function IkonGoogle({ className = 'h-5 w-5' }) {
  return (
    <svg viewBox="0 0 24 24" className={className} role="img" aria-label="Google">
      ...
      <path
        fill="#EA4335"
        d="M12 4.77c1.76 0 3.34.6 4.58 1.79l3.44-3.44A11.98 11.98 0 0 0 1.29 6.62l3.98 3.1C6.22 6.88 8.87 4.77 12 4.77Z"
      />
    </svg>
  );
}